    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "39b93f97-9d36-4ea2-9afa-326174de2a3d", "39b93f97-9d36-4ea2-9afa-326174de2a3d", "Author", "AUTHOR" },
                    { "c2c064e8-e300-4da3-a77f-8d65f46ee587", "c2c064e8-e300-4da3-a77f-8d65f46ee587", "Moderator", "MODERATOR" },
                    { "c50582de-7a9c-45f2-ade3-61503db03be9", "c50582de-7a9c-45f2-ade3-61503db03be9", "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("43b8b5ce-7cd7-484a-a4a3-c2682a15ee8c"), new DateTime(2024, 7, 26, 18, 3, 43, 123, DateTimeKind.Utc).AddTicks(3164), null, "Scientific discoveries and discussions", "#Science", "#SCIENCE", null, null },
                    { new Guid("b6bb189c-c37a-4037-b244-afae08ab77f8"), new DateTime(2024, 7, 26, 18, 3, 43, 123, DateTimeKind.Utc).AddTicks(3158), null, "All things programming", "#Programming", "#PROGRAMMING", null, null },
                    { new Guid("e98d0e4e-7435-4d2e-8afb-7e2e826fd009"), new DateTime(2024, 7, 26, 18, 3, 43, 123, DateTimeKind.Utc).AddTicks(3162), null, "Software engineering topics", "#SoftwareEngineering", "#SOFTWAREENGINEERING", null, null },
                    { new Guid("f7765147-0c8c-4ea5-b356-1606b78842e1"), new DateTime(2024, 7, 26, 18, 3, 43, 123, DateTimeKind.Utc).AddTicks(3166), null, "ASP.NET related content", "#ASP.Net", "#ASP.NET", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "39b93f97-9d36-4ea2-9afa-326174de2a3d", "680c89fa-22e3-4975-b91a-257bed6c9a97" },
                    { "c2c064e8-e300-4da3-a77f-8d65f46ee587", "680c89fa-22e3-4975-b91a-257bed6c9a97" },
                    { "c50582de-7a9c-45f2-ade3-61503db03be9", "680c89fa-22e3-4975-b91a-257bed6c9a97" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "680c89fa-22e3-4975-b91a-257bed6c9a97", 0, "7c37f0d9-b757-4da0-a72a-f4e8989d2c5f", "johndoe@email.com", true, false, null, "JOHNDOE@EMAIL.COM", "JOHNDOE", "AQAAAAIAAYagAAAAED9uuElPahmn0oc7KLt7dqbGYsE/mbr16BfXqfjFuuC2IEA3s6PMHm8+ksqhk1R8sA==", null, false, "", false, "johndoe" });

            migrationBuilder.InsertData(
                table: "Authors",
                columns: new[] { "Id", "Biography", "BlogId", "CreatedDate", "DeletedDate", "ProfilePictureImageURL", "UpdatedDate", "UserId" },
                values: new object[] { new Guid("e57300e8-3954-43b1-ac0b-01b6837c9987"), "This is John Doe's biography.", new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "https://picsum.photos/100/100", null, "680c89fa-22e3-4975-b91a-257bed6c9a97" });

            migrationBuilder.InsertData(
                table: "Blogs",
                columns: new[] { "Id", "AuthorId", "CreatedDate", "DeletedDate", "UpdatedDate" },
                values: new object[] { new Guid("8f549be5-c32c-4d47-89ba-095f2323eeae"), new Guid("e57300e8-3954-43b1-ac0b-01b6837c9987"), new DateTime(2024, 7, 26, 18, 3, 43, 123, DateTimeKind.Utc).AddTicks(3145), null, null });
