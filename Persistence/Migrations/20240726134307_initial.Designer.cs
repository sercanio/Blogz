...
namespace Persistence.Migrations
{
    ...
    [Migration("20240726134307_initial")]
            ...
            modelBuilder.Entity("Domain.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0cda14a1-bf6d-4b7d-9568-a26beb0e2a1e"),
                            ...
                            UserId = "09f020e3-97f2-44b3-8aa3-636d31ae5f45"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("57efca6f-359f-4ff8-a3c6-86d312e233dc"),
                            AuthorId = new Guid("0cda14a1-bf6d-4b7d-9568-a26beb0e2a1e"),
                            CreatedDate = new DateTime(2024, 7, 26, 13, 43, 6, 643, DateTimeKind.Utc).AddTicks(5704)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ef7f2924-ced4-4617-af11-3880f3a4c74a"),
                            BlogId = new Guid("57efca6f-359f-4ff8-a3c6-86d312e233dc"),
                            ...
                            CreatedDate = new DateTime(2024, 7, 26, 13, 43, 6, 643, DateTimeKind.Utc).AddTicks(6004),
                            IsPublic = true,
                            Slug = "introduction-to-programming--57efca6f-359f-4ff8-a3c6-86d312e233dc",
                            Title = "Introduction to Programming"
                        },
                        new
                        {
                            Id = new Guid("2bbb71b9-1317-4834-948e-8ff1362dffbb"),
                            BlogId = new Guid("57efca6f-359f-4ff8-a3c6-86d312e233dc"),
                            ...
                            CreatedDate = new DateTime(2024, 7, 26, 13, 43, 6, 643, DateTimeKind.Utc).AddTicks(6012),
                            IsPublic = true,
                            Slug = "advanced-software-engineering--57efca6f-359f-4ff8-a3c6-86d312e233dc",
                            Title = "Advanced Software Engineering"
                        },
                        new
                        {
                            Id = new Guid("bf0bc906-b03a-45bc-9729-115ccb1805dc"),
                            BlogId = new Guid("57efca6f-359f-4ff8-a3c6-86d312e233dc"),
                            ...
                            CreatedDate = new DateTime(2024, 7, 26, 13, 43, 6, 643, DateTimeKind.Utc).AddTicks(6017),
                            IsPublic = true,
                            Slug = "wonders-of-science--57efca6f-359f-4ff8-a3c6-86d312e233dc",
                            Title = "The Wonders of Science"
                        },
                        new
                        {
                            Id = new Guid("01535498-095f-4a10-9ae7-dce35d7a92b5"),
                            BlogId = new Guid("57efca6f-359f-4ff8-a3c6-86d312e233dc"),
                            ...
                            CreatedDate = new DateTime(2024, 7, 26, 13, 43, 6, 643, DateTimeKind.Utc).AddTicks(6022),
                            IsPublic = true,
                            Slug = "asp-net-core-mvc-tutorial--57efca6f-359f-4ff8-a3c6-86d312e233dc",
                            Title = "ASP.NET Core MVC Tutorial"
                        },
                        new
                        {
                            Id = new Guid("00398082-02c9-4564-8780-a61064d56ddb"),
                            BlogId = new Guid("57efca6f-359f-4ff8-a3c6-86d312e233dc"),
                            ...
                            CreatedDate = new DateTime(2024, 7, 26, 13, 43, 6, 643, DateTimeKind.Utc).AddTicks(6028),
                            IsPublic = true,
                            Slug = "best-practices-in-programming--57efca6f-359f-4ff8-a3c6-86d312e233dc",
            ...
            modelBuilder.Entity("Domain.Entities.Tag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("084ec082-07a6-4e77-a9ce-efb466fb7eab"),
                            CreatedDate = new DateTime(2024, 7, 26, 13, 43, 6, 643, DateTimeKind.Utc).AddTicks(5711),
                        ...
                        new
                        {
                            Id = new Guid("db4e5d55-1480-4268-8ba7-c96577c2481f"),
                            CreatedDate = new DateTime(2024, 7, 26, 13, 43, 6, 643, DateTimeKind.Utc).AddTicks(5716),
                        ...
                        new
                        {
                            Id = new Guid("6fd35ade-a3f2-4481-b703-d39362dd5326"),
                            CreatedDate = new DateTime(2024, 7, 26, 13, 43, 6, 643, DateTimeKind.Utc).AddTicks(5935),
                        ...
                        new
                        {
                            Id = new Guid("5d016710-665d-4c0e-aa78-f8044c48d839"),
                            CreatedDate = new DateTime(2024, 7, 26, 13, 43, 6, 643, DateTimeKind.Utc).AddTicks(5937),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "d3846293-8b11-414b-b485-81b7d9114592",
                            ConcurrencyStamp = "d3846293-8b11-414b-b485-81b7d9114592",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "6b31686d-44b4-43c4-9225-78191d67bfa8",
                            ConcurrencyStamp = "6b31686d-44b4-43c4-9225-78191d67bfa8",
                            Name = "Moderator",
                            NormalizedName = "MODERATOR"
                        },
                        new
                        {
                            Id = "f68b7b79-fbf2-4c50-9bbe-5da179d3ccfe",
                            ConcurrencyStamp = "f68b7b79-fbf2-4c50-9bbe-5da179d3ccfe",
                            Name = "Author",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "09f020e3-97f2-44b3-8aa3-636d31ae5f45",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "fb9f3b71-21a2-479c-8076-502fa3577aba",
                            Email = "johndoe@email.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "JOHNDOE@EMAIL.COM",
                            NormalizedUserName = "JOHNDOE",
                            PasswordHash = "AQAAAAIAAYagAAAAEHfVZNmqNXA9yMeSOyk4YFOtCPSz6Wlhheb6XH39mxjwpwiLvoJgeqknwW840/BfqQ==",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = "09f020e3-97f2-44b3-8aa3-636d31ae5f45",
                            RoleId = "d3846293-8b11-414b-b485-81b7d9114592"
                        },
                        new
                        {
                            UserId = "09f020e3-97f2-44b3-8aa3-636d31ae5f45",
                            RoleId = "6b31686d-44b4-43c4-9225-78191d67bfa8"
                        },
                        new
                        {
                            UserId = "09f020e3-97f2-44b3-8aa3-636d31ae5f45",
                            RoleId = "f68b7b79-fbf2-4c50-9bbe-5da179d3ccfe"
                        });
                });
